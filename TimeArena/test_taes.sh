...
do
    ...
    python LLM_test.py --taskName $item --prompting taes --lm custom --total_time 40 --save_path ./trajectory/taes_single --save_name $item
done
...
do
    save_name=$(echo $item | tr ',' '_')
    echo "===== Running dual task: $item ====="
    python LLM_test.py --taskName $item --prompting taes --lm custom --total_time 40 --save_path ./trajectory/taes_dual --save_name $save_name
done
...
do
    ...
    python LLM_test.py --taskName $item --prompting taes --lm custom --total_time 40 --save_path ./trajectory/taes_triple --save_name $save_name
done

echo "===== All 90 TAES tasks completed ====="
